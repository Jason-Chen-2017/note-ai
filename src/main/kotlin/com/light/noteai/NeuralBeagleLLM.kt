...
// NeuralBeagleLLM 随机返回 apiList 中的一个元素
fun Get_NeuralBeagle_LOCAL_API_Randomly(): String {
    val API_LIST = listOf(
...
object NeuralBeagleLLM {
    ...
    fun WriteBlog(prompt: String): String {
        ...
        return ParseNeuralBeagleResponse(res)
    }
    ...
    fun Complete(prompt: String): String {
        ...
        return ParseNeuralBeagleResponseComplete(res)
    }



    private fun ParseNeuralBeagleResponse(res: String): String {

        val gson = Gson()
        val response = gson.fromJson(res, NeuralBeagleResponse::class.java)
...
"""
    ...
    private fun ParseNeuralBeagleResponseComplete(res: String): String {

        val gson = Gson()
        val YiResponse = gson.fromJson(res, NeuralBeagleResponse::class.java)
     ...
     * }
     */
    class NeuralBeagleResponse {
        var id = "cmpl-bafc983ab99848c1b32a83cd35181377"
        var model = "mlabonne/NeuralBeagle14-7B"
